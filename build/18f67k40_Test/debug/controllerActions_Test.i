...
# 22 "controllerActions_Test.c" 2
# 36 "controllerActions_Test.c"
char *strcpyCustom(char *restrict dest, const char *restrict src) {
 const char *s = src;
 char *d = dest;
 while ((*d++ = *s++))
...
# 1629 "controllerActions_Test.c"
        if(moistureSensorFailed) {
            moistureSensorFailed = 0;


            sendSms(SmsMS1, userMobileNo, 2);
# 1643 "controllerActions_Test.c"
            lcdClear();
...
void deActivateValve(unsigned char FieldNo) {
    ...
    if (!LoraConnectionFailed && loraAttempt == 99) {
# 1775 "controllerActions_Test.c"
        sendSms(SmsIrr5, userMobileNo, 2);
# 1785 "controllerActions_Test.c"
        lcdClear();
...
# 2831 "controllerActions_Test.c"
        } else {

            sendSms(SmsRTC4, userMobileNo, 0);
# 2842 "controllerActions_Test.c"
        }
...
# 3001 "controllerActions_Test.c"
                    break;
                } else if (moistureSensorFailed) {
                    moistureSensorFailed = 0;

                    sendSms(SmsFert7, userMobileNo, 2);
# 3015 "controllerActions_Test.c"
                    break;
                } else {

                    sendSms(SmsFert6, userMobileNo, 2);
# 3028 "controllerActions_Test.c"
                    break;
                }
            }
