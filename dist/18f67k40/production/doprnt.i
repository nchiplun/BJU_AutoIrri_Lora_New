...
# 1 "C:/Users/nandu/.mchp_packs/Microchip/PIC18F-K_DFP/1.6.125/xc8\\pic\\include\\inline.h" 1 3
...
# 259 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c99\\common\\doprnt.c"
...
static int vfpfcnvrt(FILE *fp, char *fmt[], va_list ap)
{
    ...
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 814 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c99\\common\\doprnt.c"
        if (*fmt[0] == 'c') {
            ++*fmt;
